...
void three_frame_animation(ALLEGRO_BITMAP* tileset, int tw, Entity * hero,int ci1,int ci2, int ci3, int ri1, int ri2, int ri3,int aheight,int awidth,int radj, int cadj) {
	if(hero->sta_frame<=2) {
...
void walk_animation (Entity * hero, ALLEGRO_BITMAP* tileset, vector<Tile> mv, int tw, int aheight, int awidth, vector<int> wid_height, int ci1,int ci2,int ci3,int ri1, int ri2, int ri3) {
...
void move_hero (Entity * hero, ALLEGRO_BITMAP* tileset, vector<Tile> mv, vector<int> wid_height) {
	int tw = 16;
